...
namespace Car_Rent_Managment
{
    public partial class AdminDashboardForm : Form
    {
        ...
        public AdminDashboardForm(AuthenticatedUser user)
        {
            InitializeComponent();
        ...
        private void LoadDashboardSummary()
        {
            ...
            lblCarsValue.Text = ReadInt(row, "TotalCars").ToString();
            lblBookingsValue.Text = ReadInt(row, "TotalBookings").ToString();
